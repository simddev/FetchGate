...
Download **[fetchgate-0.1.6.xpi](https://github.com/simddev/FetchGate/releases/latest)** from the Releases page, then install it in Firefox or LibreWolf using either method:
...
fetchgate-0.1.6.xpi     Signed extension — install directly in Firefox or LibreWolf
