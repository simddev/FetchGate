...
(function () {
    ...
    // Guard against double-injection: once the IIFE runs to completion, the
    // second executeScript call hits this check and returns early. Because
    // NM_LIMIT_BYTES is declared inside the IIFE (not at file scope), re-injection
    // does not produce a "redeclaration of const" SyntaxError before this line runs.
